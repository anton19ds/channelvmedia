<?php
/**
 * CVM 2016 Customizer functionality
 *
 * @package WordPress
 * @subpackage CVM_2016
 * @since CVM 2016 1.0
...
function twentysixteen_custom_header_and_background() {
	...
	/**
	 * Filter the arguments used when adding 'custom-background' support in CVM 2016.
	 *
	 * @since CVM 2016 1.0
	 *
	 * @param array $args {
	...
	/**
	 * Filter the arguments used when adding 'custom-header' support in CVM 2016.
	 *
	 * @since CVM 2016 1.0
	 *
	 * @param array $args {
...
/**
 * Registers color schemes for CVM 2016.
 *
...
function twentysixteen_get_color_schemes() {
	/**
	 * Filter the color schemes registered for use with CVM 2016.
	 *
...
/**
 * Retrieves the current CVM 2016 color scheme.
 *
...
/**
 * Retrieves an array of color scheme choices registered for CVM 2016.
 *
...
/**
 * Handles sanitization for CVM 2016 color schemes.
 *
