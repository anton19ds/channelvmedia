...
<!-- ---------- JUMP LINKS ---------- -->
<div class="who-jump-links" style="display:none;">
	<ul>
		<li><a class="story" href="#story"><span class="bar"><span></span></span> Our Story</a></li>
		<li><a class="leadership" href="#leadership"><span class="bar"><span></span></span> Leadership</a></li>
		<li style="display:none;"><a class="culture" href="#culture"><span class="bar"><span></span></span> Culture</a></li>
	</ul>
</div>

<!-- ---------- HERO ---------------- -->
<div id="hero" class="grid-10 fl page-hero-section clearfix" <?php if(get_field('page_hero_background_photo')) {	echo 'style="background-image:url(' . get_field('page_hero_background_photo') . ');background-position:center bottom;background-attachment: unset;"'; } ?>>  
    <div class="overlay-white-90 pink-purple-diagonal opacity90"></div> 
...
<!-- ---------- OUR STORY ----------- -->
<?php if((get_field('our_story_left_column') || get_field('our_story_right_column') || get_field('our_story_transition_photo'))) { echo '<div id="story" class="section grid-10 fl clearfix"><div class="grid-page mauto clearfix">'; } ?>
		<?php if(get_field('our_story_section_title')) { echo '<h3 class="sp">' . get_field('our_story_section_title') . '</h3>'; } ?> 
		<?php if(get_field('our_story_left_column')) { echo '<div class="grid-4b fl ppb4 clearfix">' . get_field('our_story_left_column') . '</div>'; } ?> 
		<?php if(get_field('our_story_right_column')) { echo '<div class="grid-4b fr ppb4 clearfix">' . get_field('our_story_right_column') . '</div>'; } ?>
		<?php if(get_field('our_story_transition_photo')) { echo '<div class="overhang"><img id="overhangimg" class="responsive-img animatefade animated" src="' . get_field('our_story_transition_photo') . '" border="0" alt="Transition"/></div>'; } ?>
<?php if((get_field('our_story_left_column') || get_field('our_story_right_column') || get_field('our_story_transition_photo'))) { echo '</div></div>'; } ?> 

<!-- ---------- LEADERSHIP ---------- --> 
<?php if((get_field('leadership_list') || get_field('leadership_section_title'))) { echo '<div id="leadership" class="section grid-10 fl clearfix" style="display:none;"><div class="grid-work ppb2 clearfix">'; } ?>
		<?php if(get_field('leadership_section_title')) { echo '<h2 class="story-title-cs tac">' . get_field('leadership_section_title') . '</h2>'; } ?> 
		<?php if(get_field('leadership_list')): $i = 0; ?>
		<ul class="staff clearfix">
		<?php while(has_sub_field('leadership_list')): $i++; ?>
			<li><a class="<?php the_sub_field('name'); ?>" id="<?php the_sub_field('name'); ?>" href="javascript:;">
				<?php if( (get_sub_field('photo') == true) ){ echo '<img class="staff-photo" src="'; } ?>
				<?php the_sub_field('photo'); ?>
				<?php if( (get_sub_field('photo') == true) ){ echo '" alt="Headshot" border="0"/>'; } ?> 
				<?php if( ((get_sub_field('title') || get_sub_field('name')) == true) ){ echo '<div class="info clearfix">'; } ?>
					<?php if( (get_sub_field('title') == true) ){ echo '<h5>'; } ?>
					<?php the_sub_field('title'); ?>  
					<?php if( (get_sub_field('title') == true) ){ echo '</h5>'; } ?>
					<?php if( (get_sub_field('name') == true) ){ echo '<h4>'; } ?>
		...
		<?php endif; ?>
<?php if(get_field('leadership_list')) { echo '</div></div>'; } ?>  

<!-- ---------- CULTURE ------------- -->
<?php if(get_field('culture_section_title')) { echo '<div id="culture" class="section bg-white grid-10 fl clearfix'; } ?>
<?php if(get_field('culture_background_color')) { echo ' ' . get_field('culture_background_color') . ''; } ?>
<?php if(get_field('culture_section_title')) { echo '"'; } ?>
<?php if(get_field('culture_section_background')) { echo 'style="background:url(' . get_field('culture_section_background') . ') no-repeat center center transparent;background-size:cover;"'; } ?> 
<?php if(get_field('culture_section_title')) { echo '>'; } ?>
	<div class="grid-work ppb2 clearfix" style="display:none;">
		<?php if(get_field('culture_section_title')) { echo '<h2 class="story-title-cs tac">' . get_field('culture_section_title') . '</h2>'; } ?> 
		<?php if(get_field('culture_left_column')) { echo '<div class="grid-5 mauto clearfix">' . get_field('culture_left_column') . '</div>'; } ?> 
		<?php if(get_field('culture_right_column')) { echo '<div class="grid-5 mauto clearfix">' . get_field('culture_right_column') . '</div>'; } ?>
	</div>
<?php if(get_field('culture_section_title')) { echo '</div>'; } ?>  

<!-- ---------- INTERACTIVE MAP ---------- -->
<div class="grid-10 fl bg-dark-purple clearfix">
