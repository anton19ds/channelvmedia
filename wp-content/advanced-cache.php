...
$nitropack_functions_file = '/var/www/html/www/wp-content/plugins/nitropack/functions.php';
$nitropack_abspath = '/var/www/html/www/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_ADVANCED_CACHE_VERSION', '1.11.0');
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_1f94bc90185c9f1cd23f1e67c78408e8' );
